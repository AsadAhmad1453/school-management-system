...
!function () {
    ...
    {
        const t = document.getElementById("formValidationExamples"), o = jQuery(t.querySelector('[name="formValidationSelect2"]')), i = jQuery(t.querySelector('[name="formValidationTech"]')), l = t.querySelector('[name="formValidationLang"]'), s = jQuery(t.querySelector(".selectpicker")), r = FormValidation.formValidation(t, {
            fields: {
                ...
                formValidationConfirmPass: {
                    validators: {
                        notEmpty: {message: "Please confirm password"}, identical: {
                            compare: function () {
                ...
                }), submitButton: new FormValidation.plugins.SubmitButton, defaultSubmit: new FormValidation.plugins.DefaultSubmit, autoFocus: new FormValidation.plugins.AutoFocus
            }, init: e => {
        ...
        flatpickr(t.querySelector('[name="formValidationDob"]'), {
        ...
        }), o.length && (o.wrap('<div class="position-relative"></div>'), o.select2({placeholder: "Select country", dropdownParent: o.parent()}).on("change.select2", function () {
            ...
            name: "tech", source: (n = ["ReactJS", "Angular", "VueJS", "Html", "Css", "Sass", "Pug", "Gulp", "Php", "Laravel", "Python", "Bootstrap", "Material Design", "NodeJS"], function (e, a) {
